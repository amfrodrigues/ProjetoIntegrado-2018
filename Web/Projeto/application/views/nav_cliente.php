...
<html lang="pt">
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="<?php echo site_url('Cwallet/inic'); ?>"><img src=<?php echo base_url() . "assets/img/wallet.png" ?> style="max-witdh:40px; max-height:40px;"/>&nbsp;&nbsp;&nbsp;Wallet</a>
